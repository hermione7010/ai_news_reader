...
r"""1 simple animation is working fine 

2 google animation give error -{Traceback (most recent call last):

  File "C:\Users\Hemant ROI\Desktop\SECRET_PROJECT\ai_news\cloude_v1_2.py", line 273, in <module>

    gtts_speaker.speak_with_gtts(text)

    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~^^^^^^

  File "C:\Users\Hemant ROI\Desktop\SECRET_PROJECT\ai_news\cloude_v1_2.py", line 89, in speak_with_gtts

    self._play_with_animation(tmp_file.name)

    ~~~~~~~~~~~~~~~~~~~~~~~~~^^^^^^^^^^^^^^^

  File "C:\Users\Hemant ROI\Desktop\SECRET_PROJECT\ai_news\cloude_v1_2.py", line 96, in playwith_animation       

    pygame.mixer.music.load(audio_file)

    ~~~~~~~~~~~~~~~~~~~~~~~^^^^^^^^^^^^

pygame.error: No such file or directory: 'C:\Users\HEMANT~1\AppData\Local\Temp\tmp056c9tl9.mp3'.}

3 advanced animation error: {}"""